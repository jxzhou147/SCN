...
void write_results(const double t, const double (*a)[N], const double R[], const double (*peak)[5], const double peak_ave[], const double peak_ave_v[], const double peak_ave_d[], const double on_sun[], const double P[], const double daylength, const double tau, const double t_re, double purt, double p_link, double p_link_v, double p_link_d, double r_vd, double p_re, double d, double sigma, double K, double K_f, int flag)
{
    int ifEntrainment = 0;
    if (ifEntrain > 24)
        ifEntrainment = 1;
...
*/
    ...
    write_results(t, a, R, peak, peak_ave, peak_ave_v, peak_ave_d, on_sun, P, daylength, tau, t_re, purt, p_link, p_link_v, p_link_d, r_vd, p_re, d, sigma, K, K_f, 0);
    pthread_rwlock_unlock(&rwlock);
