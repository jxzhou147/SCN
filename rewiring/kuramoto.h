...
const double d = 1.001;     // the distance threshold of short-range links
...
const double omega_d = 2 * PI / 23.6;
const double Omega = 2 * PI / 24;
//const double K_f = 0.15; //K_f can be 0.5K, K, 2K
const double K_f = 0.1;
