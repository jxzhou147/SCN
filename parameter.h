...
//const double k_1 = 0.4;		//molecular model
...
//const double K_AP = 0.7;	//molecular model
...
const double v_sP = 1;
//const double v_sP = 1.5;	//molecular model
...
const double E_L = -29;
const double GABA_0 = 0.2;
const double v_GABA = 19;
const double K_GABA = 3;
...
const double K_VIP = 15;
const double n_VIP = 1.9;
const double k_dVIP = 0.5;
const double n_dVIP = 0.2;
const double V_MK = 5;
const double K_MK = 2.9;
const double V_beta = 2;
const double K_beta = 2;
const double C_T = 1.6;
